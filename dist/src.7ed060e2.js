...
function () {
  ...
  _createClass(ImageMgr, [{
    ...
    key: "loadImages",
    value: function loadImages(finishCallback) {
      var _this = this;
      ...
      Object.keys(config).forEach(function (key) {
        ...
        image.onload = function () {
          ...
          _this.finish(finishCallback);
        };

        image.src = "/images/".concat(name);
      });
    }
  }, {
    key: "finish",
    value: function finish(finishCallback) {
      this.loadedCount++;
...
var _default = ImageMgr;
exports.default = _default;
},{}],"../src/ownership.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"../src/metamask.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Metamask, [{
    ...
    value: function test() {
      ...
      if (this.isInstall()) {
        this.isLocked().then(function (res) {
          if (res) {
            console.log('account is locked');
          } else {
            console.log('accounts:', _this.getAccount());
          }
        });
      } else {
...
function (_React$Component) {
  ...
  _createClass(Entry, [{
    ...
    value: function onPlayClick() {
      ...
      (0, _loginCheck.check)().then(function (res) {
        var pass = true;
    ...
    value: function render() {
      ...
      })), _react.default.createElement(_map.default, null), this.state.login ? _react.default.createElement(_fundation.default, null) : _react.default.createElement("button", {
...
},{"react":"../../node_modules/react/index.js","react-dom":"../../node_modules/react-dom/index.js","./map":"../src/map.js","./image-mgr":"../src/image-mgr.js","./ownership":"../src/ownership.js","./metamask":"../src/metamask.js","./login-check":"../src/login-check.js","./fundation/fundation":"../src/fundation/fundation.js","./event-listener":"../src/event-listener.js","./page-mgr":"../src/page-mgr.js","./macro":"../src/macro.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
